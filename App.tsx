  ...
  return (
    <div className="min-h-screen text-cyan-200 animated-background">
      <div className="relative isolate min-h-screen flex flex-col p-2 sm:p-4 lg:p-6">
        <header className="flex justify-between items-center mb-4 sm:mb-6 z-[40] relative px-2 sm:px-4 py-2 sm:py-3 bg-black/20 backdrop-blur-sm border-b border-cyan-500/10 rounded-lg animate-slide-down-fade">
